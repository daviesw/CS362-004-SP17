...
int village_fct(int currentPlayer, struct gameState *state, int handPos) {
	//+1 Card
	drawCard(currentPlayer, state);
...
int great_hall_fct(int currentPlayer, struct gameState *state, int handPos) {
	//+1 Card
	drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
		adventurer_fct(drawntreasure, currentPlayer, temphand, z, state, handPos, bonus);
    ...
    case smithy:
		smithy_fct(currentPlayer, state, handPos);
		
    case village:
		village_fct(currentPlayer, state, handPos);
    ...
    case great_hall:
		great_hall_fct(currentPlayer,state,handPos);
    ...
    case salvager:
		salvager_fct(choice1, state, currentPlayer, handPos);
